...
const hymnId = 'teen-anastaseen';
const hymnData = {
    name: "Teen Anastaseen",
    description: "The 4th hymn chanted during the procession of the resurrection until the 39th day of the holy 50 days.",
    genreId: ["resurrection"],
    lyricsArabic: "lyrics/arabic/teen-anastaseen_arabic.md",
    lyricsCoptic: "lyrics/coptic/teen-anastaseen_coptic.md",
    lyricsEnglish: "lyrics/english/teen-anastaseen_english.md"
};

const recordingId = 'cantor-ibrahim_teen-anastaseen';
const recordingData = {
    hymnId: "teen-anastaseen",
    cantorId: "cantor-ibrahim",
    audioUrl: "tracks/cantor-ibrahim/cantor-ibrahim_teen-anastaseen.mp3",
    markersUrl: "markers/cantor-ibrahim/cantor-ibrahim_teen-anastaseen_markers.txt",
    audioLength: 150.857125,
    active: true,
    mode: "learn"
};
