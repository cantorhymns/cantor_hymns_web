...
const hymnId = 'panouti';
const hymnData = {
    name: "Panouti Panouti",
    description: "Chanted in the distribution of the Holy Mysteries on Bright Saturday of Holy Pascha.",
    genreId: ["lent"],
    lyricsArabic: "lyrics/arabic/panouti_arabic.md",
    lyricsCoptic: "lyrics/coptic/panouti_coptic.md",
    lyricsEnglish: "lyrics/english/panouti_english.md"
};

const recordingId = 'cantor-ibrahim_panouti';
const recordingData = {
    hymnId: "panouti",
    cantorId: "cantor-ibrahim",
    audioUrl: "tracks/cantor-ibrahim/cantor-ibrahim_panouti.mp3",
    markersUrl: "markers/cantor-ibrahim/cantor-ibrahim_panouti_markers.txt",
    audioLength: 912.248125,
    active: true,
    mode: "learn"
};
