...
const hymnId = 'verses-of-cymbals-lazarus-saturday';
const hymnData = {
...
const recordingId = 'cantor-tharwat_verses-of-cymbals-lazarus-saturday';
const recordingData = {
    hymnId: "verses-of-cymbals-lazarus-saturday",
    cantorId: "cantor-tharwat",
    audioUrl: "tracks/cantor-tharwat/cantor-tharwat_lazaros.mp3",
    markersUrl: "markers/cantor-tharwat/cantor-tharwat_verses-of-cymbals-lazarus-saturday_markers.txt",
    audioLength: 20.8979375,
    active: true,
    mode: "listen"
};
