...
const hymnId = 'aspasmos-watos-lent-1';
const hymnData = {
    name: "Aspasmos Watos",
    description: "Aspasmos Watos for Great Lent. Verses are also found in the doxology.",
    genreId: ["lent"],
    lyricsArabic: "lyrics/arabic/aspasmos-watos-lent-1_arabic.md",
    lyricsCoptic: "lyrics/coptic/aspasmos-watos-lent-1_coptic.md",
