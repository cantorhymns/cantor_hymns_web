...
const hymnId = 'tou-lithou';
const hymnData = {
    name: "Tou Lithou",
    description: "The 3rd hymn chanted during the procession of the resurrection until the 39th day of the holy 50 days.",
    genreId: ["resurrection"],
    lyricsArabic: "lyrics/arabic/tou-lithou_arabic.md",
    lyricsCoptic: "lyrics/coptic/tou-lithou_coptic.md",
    lyricsEnglish: "lyrics/english/tou-lithou_english.md"
};

const recordingId = 'cantor-ibrahim_tou-lithou';
const recordingData = {
    hymnId: "tou-lithou",
    cantorId: "cantor-ibrahim",
    audioUrl: "tracks/cantor-ibrahim/cantor-ibrahim_tou-lithou.mp3",
    markersUrl: "markers/cantor-ibrahim/cantor-ibrahim_tou-lithou_markers.txt",
