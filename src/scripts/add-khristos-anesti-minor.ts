...
const hymnId = 'khristos-anesti-minor';
const hymnData = {
    name: "Khristos Anesti (Minor)",
    description: "The hymn of the resurrection, Khristos Anesti, in its minor tune.",
    genreId: ["resurrection"],
    lyricsArabic: "lyrics/arabic/khristos-anesti_arabic.md",
    lyricsCoptic: "lyrics/coptic/khristos-anesti_coptic.md",
    lyricsEnglish: "lyrics/english/khristos-anesti_english.md"
};

const recordingId = 'cantor-ibrahim_khristos-anesti-minor';
const recordingData = {
    hymnId: "khristos-anesti-minor",
    cantorId: "cantor-ibrahim",
    audioUrl: "tracks/cantor-ibrahim/cantor-ibrahim_khristos-anesti-minor.mp3",
    markersUrl: "markers/cantor-ibrahim/cantor-ibrahim_khristos-anesti-minor_markers.txt",
    audioLength: 116.9240833333333,
    active: true,
    mode: "learn"
};
