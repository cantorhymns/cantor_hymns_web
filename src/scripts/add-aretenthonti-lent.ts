...
const hymnId = 'aretenthonti-lent';
const hymnData = {
    name: "Aretenthonti",
...
const recordingId = 'cantor-ibrahim_aretenthonti-lent';
const recordingData = {
    hymnId: "aretenthonti-lent",
    cantorId: "cantor-ibrahim",
    audioUrl: "tracks/cantor-ibrahim/cantor-ibrahim_aretenthonti-lent.mp3",
    markersUrl: "markers/cantor-ibrahim/cantor-ibrahim_aretenthonti-lent_markers.txt",
    audioLength: 823.04,
    active: true,
    mode: "learn"
};
